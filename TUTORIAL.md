...
- Make sure you are in the `learn-bash-by-building-a-boilerplate` folder when you enter the command
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate` to get to the `learn-bash-by-building-a-boilerplate` folder if you aren't there

## 20. List

### 20.1

The output tells you where the folder you are in is located. You are in the `learn-bash-by-building-a-boilerplate` folder, which is in the `CodeAlly` folder, which is in the `home` folder. Type `ls` into the terminal to see what's in this folder. `ls` stands for "list".
...
- Make sure you start in the `learn-bash-by-building-a-boilerplate` folder first
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate` to get to the `learn-bash-by-building-a-boilerplate` folder if you aren't there
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/freeCodeCamp` to get to the `freeCodeCamp` folder if you aren't there

## 50. List

### 50.1

You can see the path of the `freeCodeCamp` folder. It's in the `learn-bash-by-building-a-boilerplate` folder you were just in. List the contents of the `freeCodeCamp` folder to see what's here.
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/freeCodeCamp/test` to get to the `test` folder if you aren't there
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/freeCodeCamp` to get back to the `freeCodeCamp` folder and try again
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/freeCodeCamp/node_modules` to get to the `node_modules` folder if you aren't there
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/freeCodeCamp/node_modules/has` to get to the `has` folder if you aren't there
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/freeCodeCamp/node_modules/has/src` to get to the `src` folder if you aren't there
...
You can go back two folders with `cd ../..`. Each set of dots represents another folder level. Go back to the `learn-bash-by-building-a-boilerplate` directory from the `node_modules` directory.

#### HINTS

- Be sure to go back two folders with one command
- Type `cd ../..` into the terminal from the `node_modules` folder
- Make sure you go from `node_modules` to `learn-bash-by-building-a-boilerplate`
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/freeCodeCamp/node_modules` to get to the `node_modules` folder if you aren't there
...
You are back in the `learn-bash-by-building-a-boilerplate` folder where you started. List what's in here again.

#### HINTS

- Use the "list" command
- Enter `ls` into the terminal
- Make sure you are in the `learn-bash-by-building-a-boilerplate` folder first
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate` to get to the `learn-bash-by-building-a-boilerplate` folder if you aren't there
...
You will be making a website boilerplate. You can make a new folder with `mkdir <folder_name>`. `mkdir` stands for "make directory". Make a `website` directory in this `learn-bash-by-building-a-boilerplate` folder. Remember that "directory" and "folder" mean the same thing.

#### HINTS

- Enter `mkdir website` into the terminal
- Make sure to make it in the `learn-bash-by-building-a-boilerplate` folder
...
- Enter the command from the `learn-bash-by-building-a-boilerplate` folder
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate` to get to the `learn-bash-by-building-a-boilerplate` folder if you aren't there
- If you used the reset button, you may need to enter the above command to get to the correct folder even if it looks like you're already there
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/website` to get to the `website` folder if you aren't there
- If you used the reset button, you may need to enter the above command to get to the correct folder even if it looks like you're already there
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/website/images` to get to the `images` folder if you aren't there
- If you used the reset button, you may need to enter the above command to get to the correct folder even if it looks like you're already there
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/website/client` to get to the `client` folder if you aren't there
- If you used the reset button, you may need to enter the above command to get to the correct folder even if it looks like you're already there
...
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/website/client/assets` to get to the `assets` folder if you aren't there
- If you used the reset button, you may need to enter the above command to get to the correct folder even if it looks like you're already there
...
- Enter `touch background.jpg` in the terminal
- Make sure you are in the `images` folder first
- Enter `cd /workspace/learn-bash-by-building-a-boilerplate/website/client/assets/images` to get to the `images` folder if you aren't there
- If you used the reset button, you may need to enter the above command to get to the correct folder even if it looks like you're already there
...
:smile: Change to the `learn-bash-by-building-a-boilerplate` folder.
...
List the contents of the `learn-bash-by-building-a-boilerplate` folder to see the new copy.
